...
my $file = $ARGV[0] or die "Error: Provide an information file on the command line that lists the metadata to filter specimen data. An example file, PodophyllumPeltatum.info.txt is provided as a template.\nExample usage: \n$0 PodophyllumPeltatum.info.txt\n";
...
print "Parsed data are in " . $infoH{"output"} . "\n";
close $fh;
close OUT;
